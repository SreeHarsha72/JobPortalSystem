  ...
  render() {
    return (
      <div>
        ...
        <Form className="form" style={{  marginTop: "80px" , marginLeft: "380px",width: "1500px",
    height: "1200px"}} onSubmit={this.onSubmit}>
          ...
          <p className="register text-right"> Already had an Account 
